...
const App = () => {
  ...
  if (isLoading) {
    return (
      <div class="w-[350px] h-[400px] bg-primary flex items-center justify-center">
  ...
  return (
    <div class="w-[350px] h-[400px] bg-primary relative overflow-hidden">
      {!isValidWebPage ? (
        ...
        <div class="relative h-full">
          {/* Popup View */}
          <div
            class={`h-full p-4 transition-transform duration-300 ease-in-out ${
          ...
          {/* Settings View */}
          <div
            class={`absolute top-0 left-0 w-full h-full p-4 overflow-y-auto transition-transform duration-300 ease-in-out ${
